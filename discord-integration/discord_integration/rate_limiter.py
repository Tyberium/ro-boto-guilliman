...
from discord_integration.settings import DiscordSettings, get_discord_settings
...
class RateLimiter:
    def __init__(
        ...
        discord_settings: DiscordSettings | None = None,
    ) -> None:
        self.core_settings = core_settings or get_settings()
        self.discord_settings = discord_settings or get_discord_settings()
    ...
    def check(self, sender_key: str) -> bool:
        ...
        window_seconds = self.discord_settings.rate_limit_window_seconds
        max_requests = self.discord_settings.rate_limit_requests
